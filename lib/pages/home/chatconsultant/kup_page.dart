...
class KUPPage extends StatefulWidget {
  const KUPPage({super.key});

  @override
  State<KUPPage> createState() => _KUPPageState();
}

class _KUPPageState extends State<KUPPage> {
        ...
        children: [
          StreamBuilder<QuerySnapshot>(
              stream: db
                  ...
                  .where('expertise', arrayContains: 'KUP')
                  .snapshots(),
