...
class AplikasiPajakPage extends StatefulWidget {
  const AplikasiPajakPage({super.key});

  @override
  State<AplikasiPajakPage> createState() => _AplikasiPajakPageState();
}

class _AplikasiPajakPageState extends State<AplikasiPajakPage> {
        ...
        children: [
          StreamBuilder<QuerySnapshot>(
              stream: db
                  ...
                  .where('expertise', arrayContains: 'PPh')
                  .snapshots(),
