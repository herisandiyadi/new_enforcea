...
class AdminPajakPage extends StatefulWidget {
  const AdminPajakPage({super.key});

  @override
  State<AdminPajakPage> createState() => _AdminPajakPageState();
}

class _AdminPajakPageState extends State<AdminPajakPage> {
        ...
        children: [
          StreamBuilder<QuerySnapshot>(
              stream: db
                  ...
                  .where('expertise', arrayContains: 'Administrasi Perpajakan')
                  .snapshots(),
